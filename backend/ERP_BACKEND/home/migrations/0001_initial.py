# Generated by Django 4.0.3 on 2022-05-31 11:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('backImg', models.ImageField(blank=True, default='', help_text='Insert Front Image', null=True, upload_to=home.models.changeImgName, verbose_name='Front Image')),
                ...
                ('readDate', models.DateField(blank=True, default=None, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Event',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('answerDay', models.DateField(blank=True, help_text='Insert The Date', null=True, verbose_name='Date')),
                ('answerBool', models.BooleanField(null=True)),
                ('answer', models.CharField(blank=True, help_text='Insert The Possible Answer', max_length=500, null=True, verbose_name='Answer')),
            ],
        ),
        migrations.CreateModel(
            name='PatrolDay',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fk_days', models.ManyToManyField(blank=True, null=True, to='home.patrolday')),
                ('fk_patrol', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('fk_quests', models.ManyToManyField(default=home.models.PatrolWeek.allQuests, to='home.patrolquest')),
            ],
        ),
        migrations.AddField(
            model_name='patrolanswer',
            name='fk_patrolquest',
            field=models.ForeignKey(help_text='Insert The Patrol Quest', on_delete=django.db.models.deletion.CASCADE, to='home.patrolquest', verbose_name='Quest'),
        ),
        migrations.AddField(
            model_name='patrolanswer',
            name='fk_patrolweek',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='home.patrolweek'),
        ),
        migrations.AddField(
            model_name='event',
            name='location',
