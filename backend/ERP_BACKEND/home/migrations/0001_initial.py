# Generated by Django 4.0.3 on 2022-05-21 22:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answerBool', models.CharField(blank=True, max_length=10, null=True)),
                ...
                ('fk_patrolweek', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='home.patrolweek')),
            ],
        ),
        migrations.CreateModel(
            name='GeneratedAnswerFields',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('patrol_week_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.patrolweek')),
            ],
        ),
        migrations.AddField(
            model_name='event',
